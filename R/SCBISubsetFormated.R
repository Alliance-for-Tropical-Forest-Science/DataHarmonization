#' SCBISubsetFormated
#'
#' This is the standardized version of a subset of Smithsonian Conservation Biology Institute's ForestGEO plot's data, for which some errors were introduced to test the correction functions
#'
#' @format A tibble
#' \describe{
