...
*Attention*: this inventory contains errors that have been deliberately
added in order to test their detection.
...
- 4 dummy sub-sub-squares created for the package to be use as plots in
  long format. Dataset extracted from the Guyafor database *WITH ADDING
  ERRORS*
