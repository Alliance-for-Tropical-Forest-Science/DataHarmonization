...
This is the standardized version of a subset of Smithsonian Conservation
Biology Institute's ForestGEO plot's data, for which some errors were
introduced to test the correction functions
...
- ScientificName, ScientificNameOriginal:
...
- StemFieldNum, StemFieldNumOriginal:

  Stem identifiers within the tree.

- IdStem, IdStemOriginal:
...
- IdMeasure:
  ...
  measure unique identifier if you had more than one measure per stem
  per year
