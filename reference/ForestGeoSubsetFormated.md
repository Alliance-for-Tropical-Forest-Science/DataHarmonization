...
This is the standardized, formated version of ForestGeoSubset (see
help(ForestGeoSubset))
...
- TreeCodes:
  ...
  Codes associated to tree, separated by commas. The definition of each
  code is given in ...
